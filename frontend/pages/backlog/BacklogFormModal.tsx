...
const TYPE_OPTIONS     = [
  'VIP', 'Media', 'External', 'OEM Support',
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden mx-4">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label text="Preferred Date / Window" />
              <input className={inputCls} type="text" placeholder="e.g. July 2026, 15 Aug" value={form.preferred_demo_date ?? ''} onChange={set('preferred_demo_date')} />
            </div>
            <div>
              <Label text="Preferred Time" />
              <input className={inputCls} type="text" placeholder="e.g. 10:00–12:00 JST" value={form.preferred_time ?? ''} onChange={set('preferred_time')} />
            </div>
          </div>
