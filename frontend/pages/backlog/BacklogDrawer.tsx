        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-6 py-5 space-y-6">
            ...
            <div>
              ...
              {editMode ? (
                <>
                  <EditField label="Pref. Date" value={merged('preferred_demo_date')} onChange={set('preferred_demo_date')} />
                  <EditField label="Pref. Time" value={merged('preferred_time')}      onChange={set('preferred_time')} />
