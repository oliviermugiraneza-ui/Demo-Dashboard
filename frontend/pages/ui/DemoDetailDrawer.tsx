      ...
      >
        ...
        <div className="px-6 pt-8 pb-4 border-b border-border bg-white">
          ...
          <div className="flex items-center gap-2 flex-wrap mt-2.5">
            ...
            {demo.demo_ref && (
              <span className="inline-flex items-center text-[11px] font-bold px-2 py-0.5 rounded bg-blue-50 text-blue-700 border border-blue-100 font-mono tracking-wide">
                {demo.demo_ref}
              </span>
            )}
          </div>
        ...
        <div className="px-6 py-4 space-y-5 flex-1">
          ...
          <div>
            ...
            <Row label="Demo Ref"  value={demo.demo_ref || '—'} />
