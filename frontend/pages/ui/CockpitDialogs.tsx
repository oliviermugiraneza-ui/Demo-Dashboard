...
import { DEMO_TYPES as DEMO_TYPES_CONST } from '../../lib/constants/demoTypes'
...
const DEMO_TYPES = [...DEMO_TYPES_CONST]
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Demo — {demo?.demo_ref ?? demo?.id}</DialogTitle>
        </DialogHeader>
        <div className="space-y-3 py-1">
          <div className="grid grid-cols-2 gap-3">
            <div>
